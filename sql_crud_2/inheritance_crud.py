...
class MainWindow(QMainWindow):
    def __init__(self, *args):
        ...
        # self.pushButton_read.clicked.connect(self.read_data)
    ...
    #
    #     cursor.execute("SELECT * FROM person_crud WHERE id=?", (id,))
    #     person_crud = cursor.fetchone()
    #     if person_crud:
    #         self.lineEdit_name.setText(person_crud[1])
    #         self.lineEdit_surname.setText(person_crud[2])
    #     else:
